...
## Contiene riferimenti runtime agli item istanziati e informazioni di spawn.[br]
var items_state: RoomItemState

## Stato dei nemici della stanza.[br]
## Contiene queue, ondate, nemici vivi, nemici totali, ecc.[br]
var enemies_state: RoomEnemyState

## Stato delle trappole della stanza.[br]
## Contiene riferimenti e informazioni di spawn delle trappole.[br]
var traps_state: RoomTrapState

## Stato delle decorazioni della stanza.[br]
## Contiene riferimenti runtime alle decorazioni istanziate.[br]
...
## Indica se la stanza è stata completata dal player.[br]
##[br]
## True se:[br]
## - il combattimento (se presente) termina con successo[br]
## - le porte sono sbloccate definitivamente[br]
##[br]
## Questo valore viene tipicamente settato da [RoomsManager] a fine combattimento.[br]
var done: bool = false
...
## Costruisce lo stato runtime della stanza.[br]
##[br]
## Permette di iniettare stati già esistenti oppure creare stati di default.[br]
## Tipicamente usato durante la build del mondo / inizializzazione run.[br]
##[br]
## [param _items_state] Stato iniziale degli item (default: [RoomItemState].new()).[br]
## [param _enemies_state] Stato iniziale dei nemici (default: [RoomEnemyState].new()).[br]
## [param _trap_state] Stato iniziale delle trappole (default: [RoomTrapState].new()).[br]
## [param _decos_state] Stato iniziale delle decorazioni (default: [RoomDecoState].new()).[br]
func _init(
